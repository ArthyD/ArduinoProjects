...
#include <DHT.h>
#include <SPI.h>
char ssid[] = "PlantAP";        // your network SSID (name)
char pass[] = "strongPass";    // your network password (use for WPA, or use as key for WEP)
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.print(String(moisture));
            client.print("<h1>Switch LED</h1>");
